    ...
    return (
        <div className='p-4 my-4'>
            ...
            <div className='flex flex-col border-2 border-indigo-400 rounded-xl w-[600px] p-4 mx-auto' style={{ width: '800px' }}>
                ...
                <div className='my-4'>
                    <label className='mr-4 font-bold font-mono text-indigo-800 text-2xl'>Story</label>
                    <textarea
                        type='text'
                        value={story}
                ...
                <button className='p-2 bg-blue-500 hover:bg-indigo-600 m-8 font-mono text-white text-xl' onClick={handleEditBlog}>
                    Update me
                </button>
            </div>
        </div>
